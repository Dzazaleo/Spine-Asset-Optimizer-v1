...
const { useMemo } = React;
const { FileText, AlertTriangle, Layers, Zap, Bone, Clock, Shield, MessageSquare, Image, Film } = lucide;
    ...
    <div className="min-h-screen bg-[#1e1e23] text-gray-200 font-sans p-6 md:p-12">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Safety Buffer */}
                <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-5 flex flex-col gap-2">
                    ...
                    <p className="text-sm text-gray-400">Safety Buffer (Runtime Resolution Scale)</p>
                </div>
